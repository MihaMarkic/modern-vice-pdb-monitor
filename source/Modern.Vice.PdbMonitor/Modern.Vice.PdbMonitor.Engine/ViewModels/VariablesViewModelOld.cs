...
public abstract class VariableValue
{
    ...
    public VariableValue(ushort address, ImmutableArray<byte> data, ImmutableArray<VariableValue> items)
    {
        Items = items;
        Address = address;
        Data = data;
...
public class PtrVariableValue : VariableValue
{
    ...
    public PtrVariableValue(ushort address, ImmutableArray<byte> data, ushort pointerAddress)
        : base(address, data, ImmutableArray<VariableValue>.Empty)
    {
